import { OcrDocumentCard } from './OcrDocumentCard';
...
type OcrHistoryLeftPanelProps = {
  documents: Array<OcrDocument>;
  onDocumentClick?: (documentId: string) => void;
};

export function OcrHistoryLeftPanel({
  documents,
  onDocumentClick,
}: OcrHistoryLeftPanelProps) {
  return (
      ...
      <div className="flex-1 flex flex-col gap-4 p-4 overflow-hidden min-h-0">
        ...
        <div className="flex flex-col gap-4 h-full overflow-hidden relative">
          <h3 className="text-base font-semibold text-gray-1 leading-6 shrink-0">
            Recent Document ({documents.length})
          </h3>
